    ...
    <div>
      <div className="page-header">
        ...
        <div>
          <button
            type="button"
            id="downloadTableBtn"
            className="fui-Button download-badge"
      ...
      <div className="filters-grid">
        <div className="filter-item">
          <label className="fui-Label" htmlFor="issueDateFilter">
            發佈日期
          </label>
          <input
            id="issueDateFilter"
        ...
        <div className="filter-item">
          <label className="fui-Label" htmlFor="subjectFilter">
            科目
          </label>
          <select
            id="subjectFilter"
        ...
        <div className="filter-item">
          <label className="fui-Label" htmlFor="dueStatusFilter">
            截止狀態
          </label>
          <select
            id="dueStatusFilter"
        ...
        <div className="stat-items-container">
          <div className="stat-item stat-today-issued">
            <div className="stat-content">
              ...
              <div id="issuedTodayCount" className="stat-value">
                {countIssuedBy(issueDate)}
              </div>
            </div>
          </div>
          <div className="stat-item stat-today-due">
            <div className="stat-content">
              ...
              <div id="dueTodayCount" className="stat-value">
                {countDueBy(issueDate)}
              </div>
            </div>
          </div>
        </div>
              ...
              {filtered.map((it) => {
                ...
                return (
                  <tr key={String(it.id)} className={statusClass}>
                    ...
                    <td>{it.issue_date}</td>
                    <td className="deadline-cell" data-deadline={it.due_date}>
                      {it.due_date}
                    </td>
